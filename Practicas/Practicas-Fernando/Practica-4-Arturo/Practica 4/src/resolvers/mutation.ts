...
export const Mutation = {
    //Funciona
    crearVendedor: async (_: any, args: {nombre: String, numeroEmpleado: String, email: String, concesionario?: string, coches?: Coche[] | undefined}): Promise<Vendedor> => {
        try {
